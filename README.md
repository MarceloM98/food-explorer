...
- [x] Possibilidade de fazer uma busca pelo nome do prato, pelos ingredientes
- [x] Consumir uma API própria
- [] Aplicação responsiva
- [x] Aplicar animações, transições e transformações (entre outros exemplos) para deixar a experiência da aplicação mais fluida.
